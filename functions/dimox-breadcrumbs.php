 ...
 */
 ...
 /*
	* With kldev (Bootstrap 5) modifications; see //----kldev// {...} //----//
  ...
  */
	...
	$text['category'] = 'Kategoria "%s"'; // text for a category page
	$text['search']   = 'Rezultat zapytania "%s" dla'; // text for a search results page
	$text['tag']      = 'Post z tagiem "%s"'; // text for a tag page
	$text['author']   = 'Artykułu opublikowane przez %s'; // text for an author page
	$text['404']      = 'Błąd 404'; // text for the 404 page
	$text['page']     = 'Podstrona %s'; // text 'Page N'
	$text['cpage']    = 'Podstrona z komentarzami %s'; // text 'Comment Page N'
