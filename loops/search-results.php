...
<header class="wrap-lg py-5 text-center">
  <h1 class="display-4 my-5">
    <?php _e('Wyniki wyszukiwania dla: ', 'kldev'); ?> &ldquo;<?php the_search_query(); ?>&rdquo;
  </h1>
</header>
...
<?php endwhile; else: ?>
  <div class="wrap-md pb-5 entry-content">
    <article class="alert alert-warning px-3">
      <i class="bi bi-exclamation-triangle"></i> <?php _e('Przepraszamy, brak wyników dla zapytania.', 'kldev'); ?>
    </article>
  </div>
<?php endif; ?>